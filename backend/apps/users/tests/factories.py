...
class UserFactory(factory.django.DjangoModelFactory):
    ...
    def groups(self, create: bool, extracted: list[str] | None, **kwargs):
        if not create:
            return
    ...
    @factory.post_generation
    def sign_up_tenant(self, create: bool, extracted: list[str] | None, **kwargs):
        if not create:
            return
...
def image_factory(name: str, params: ImageFactoryParams | None = None) -> UploadedFile:
